...
$(function(){$(".sf-menu").superfish({cssArrows:!1,hoverClass:"active-menu",delay:200});var e=$(".slider");e.owlCarousel({loop:!0,items:1,itemClass:"slide-wrap",nav:!0,autoplay:!0,autoplaySpeed:3e3,autoplayTimeout:8e3,navText:""}),$(".next").click(function(){e.trigger("next.owl.carousel")}),$(".prev").click(function(){e.trigger("prev.owl.carousel")});var i=$(".slider-our-clients");i.owlCarousel({rtl:!0,loop:!0,autoplay:!0,autoplaySpeed:3e3,autoplayTimeout:8e3,margin:30,nav:!0,navText:"",itemClass:"slider-our-client-wrap",responsive:{0:{items:1},600:{items:3},1e3:{items:5}}}),$(".slider-our-client-nav .next").click(function(){i.trigger("next.owl.carousel")}),$(".slider-our-client-nav .prev").click(function(){i.trigger("prev.owl.carousel")}),$("#my-menu").mmenu({extensions:["pagedim-black","effect-menu-slide","fx-menu-slide","fx-listitems-drop","border-none"],navbar:{title:'<img src="img/logo.svg" alt="Логотип" style="width: 150px; height: auto;"/>'}});var a=$("#my-menu").data("mmenu");a.bind("open:start",function(){$(".hamburger").addClass("is-active")}),a.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".about-us .about-item p").equalHeights(),new Vue({el:"#Caruosel3D",data:{slides:7},components:{"carousel-3d":Carousel3d.Carousel3d,slide:Carousel3d.Slide}}),$(".dial").knob({}),$(".dial").trigger("configure",{min:0,max:100,angleOffset:-90,angleArc:180,rotation:"anticlockwise",fgColor:"#e8645a",bgColor:"#76c7c0",width:120,height:70,thickness:.25})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});